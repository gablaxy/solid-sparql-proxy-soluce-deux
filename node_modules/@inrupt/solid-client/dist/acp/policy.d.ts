import { type SolidDataset, type Thing, type ThingPersisted, type Url, type UrlString } from "../interfaces";
 ...
 * @since 1.6.0
 */
export type AnonymousResourcePolicy = Thing & {
    url: BlankNodeId;
};
/**
...
export declare function getResourcePolicyAll(resourceWithAcr: WithAccessibleAcr, options: {
